...
### `snp`
`snp` (from `snp.csv`) contains `r nrow(snp)` observations of `r ncol(snp)` variables related to  Standard & Poor’s stock market index (S&P) in a specific month of the associated year from `r min(snp$year)` to `r max(snp$year)`:
